...
from account.decorators import login_required, super_admin_required, check_contest_permission
...
class SubmissionListAPI(APIView):
    def is_not_super_admin(self):
        if super_admin_required.check_permission(self):
            return 0
        return 1
    ...
    def get(self, request):
        ...
        if SubmissionListAPI.is_not_super_admin(self):
            submissions = submissions.filter(~Q(username__icontains="root"))
